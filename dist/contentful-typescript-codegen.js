...
function renderContentType$2(contentType) {
    var name = renderContentTypeId(contentType.sys.id);
    var fields = renderContentTypeFields$1(contentType.fields);
    return renderInterface({
        name: name,
...
function renderPropsOnly(contentTypes) {
    return __awaiter(this, void 0, void 0, function () {
        var sortedContentTypes, source;
        return __generator(this, function (_a) {
            sortedContentTypes = contentTypes.sort();
            source = renderAllContentTypes$2(sortedContentTypes);
            return [2 /*return*/, prettier.format(source, { parser: "typescript" })];
        });
    });
}
function renderAllContentTypes$2(contentTypes) {
    return contentTypes.map(function (contentType) { return renderContentType$2(contentType); }).join("\n\n");
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [3 /*break*/, 9];
                case 5:
                    if (!cli.flags.propsOnly) return [3 /*break*/, 7];
                    return [4 /*yield*/, renderPropsOnly(contentTypes.items)];
                case 6:
                    output = _a.sent();
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, render(contentTypes.items, locales.items)];
                case 8:
                    output = _a.sent();
                    _a.label = 9;
                case 9:
